...
const defaultStreamHandler = handlerCallback.defineHandlerCallback(
  async ({ request, router, responseHeaders }) => {
    if (typeof ReactDOMServer.renderToReadableStream === "function") {
      ...
      const responseStream = transformStreamWithRouter.transformReadableStreamWithRouter(
        router,
        stream
      );
    ...
    if (typeof ReactDOMServer.renderToPipeableStream === "function") {
      ...
      const responseStream = transformStreamWithRouter.transformPipeableStreamWithRouter(
        router,
        reactAppPassthrough
      );
      return new Response(responseStream, {
